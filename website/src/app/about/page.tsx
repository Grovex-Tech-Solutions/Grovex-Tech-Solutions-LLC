        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-background-secondary rounded-xl shadow-lg p-6 sm:p-8 lg:p-10 mb-8 sm:mb-12 lg:mb-16">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 lg:mb-8">
              <h2 className="text-foreground text-2xl sm:text-3xl lg:text-4xl font-bold">Skills & Real-World Experience</h2>
              <a
                href="https://github.com/Grovex-Tech-Solutions"
                className="inline-flex items-center gap-2 self-start rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-primary-dark"
                target="_blank"
            ...
            <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-primary/10 rounded-xl border-l-4 border-primary">
              ...
              <p className="text-sm sm:text-base text-foreground-secondary leading-relaxed mb-3">
                Explore the GroveX Tech GitHub for examples of automation, web development, and other technical work that shows how we think and build.
              </p>
